...
(function(E, A) {
    ...
    function ca(a, b, d, e) {
        if (c.isArray(b) && b.length) c.each(b, function(f, h) { d || Na.test(a) ? e(a, h) : ca(a + "[" + (typeof h === "object" || c.isArray(h) ? f : "") + "]", h, d, e); });
        else if (!d && b != null && typeof b === "object")
            c.isEmptyObject(b) ?
                e(a, "") : c.each(b, function(f, h) { ca(a + "[" + f + "]", h, d, e); });
        else e(a, b);
    }

    function S(a, b) {
        var d = { };
        c.each(na.concat.apply([], na.slice(0, b)), function() { d[this] = a; });
        return d;
    }
    ...
    var u = E.document, c = function() {
        ...
        b.fn = b.prototype = {
            ...
            get: function(i) { return i == null ? this.toArray() : i < 0 ? this.slice(i)[0] : this[i]; },
            ...
            each: function(i, r) { return b.each(this, i, r); },
            ready: function(i) {
                b.bindReady();
        ...
        b.extend({
            ...
            isFunction: function(i) { return b.type(i) === "function"; },
            isArray: Array.isArray || function(i) { return b.type(i) === "array"; },
            isWindow: function(i) { return i && typeof i === "object" && "setInterval" in i; },
            isNaN: function(i) {
                return i ==
                    null || !v.test(i) || isNaN(i);
            },
            type: function(i) { return i == null ? String(i) : L[x.call(i)] || "object"; },
            ...
            trim: R ? function(i) { return i == null ? "" : R.call(i); } : function(i) { return i == null ? "" : i.toString().replace(l, "").replace(n, ""); },
        ...
        b.each("Boolean Number String Function Array Date RegExp Object".split(" "), function(i, r) { L["[object " + r + "]"] = r.toLowerCase(); });
        m = b.uaMatch(m);
        if (m.browser) {
        ...
        val: function(a) {
            ...
            return this.each(function(n) {
                ...
                if (this.nodeType === 1) {
                    ...
                    else if (c.isArray(v)) v = c.map(v, function(D) { return D == null ? "" : D + ""; });
    ...
    var X = /\.(.*)$/ , ha = /^(?:textarea|input|select)$/i , Ha = /\./g , Ia = / /g , Ua = /[^\w\s.|`]/g , Va = function(a) { return a.replace(Ua, "\\$&"); }, sa = { focusin: 0, focusout: 0 };
    c.event = {
        ...
        special: {
            ...
            live: {
                add: function(a) { c.event.add(this, Y(a.origType, a.selector), c.extend({ }, a, { handler: Ga, guid: a.handler.guid })); },
                remove: function(a) {
                    c.event.remove(this,
    ...
    c.removeEvent = u.removeEventListener ? function(a, b, d) { a.removeEventListener && a.removeEventListener(b, d, false); } : function(a, b, d) { a.detachEvent && a.detachEvent("on" + b, d); };
    c.Event = function(a) {
    ...
    c.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, function(a, b) { c.event.special[a] = { setup: function(d) { c.event.add(this, b, d && d.selector ? ua : ta, a); }, teardown: function(d) { c.event.remove(this, b, d && d.selector ? ua : ta); } }; });
    ...
    u.addEventListener && c.each({ focus: "focusin", blur: "focusout" }, function(a, b) {
        ...
        c.event.special[b] = {
            setup: function() { sa[b]++ === 0 && u.addEventListener(a, d, true); },
            teardown: function() {
                --sa[b] ===
    ...
    (function() {
        ...
        l.matches = function(g, j) { return l(g, null, null, j); };
        l.matchesSelector = function(g, j) { return l(j, null, null, [g]).length > 0; };
        ...
        l.error = function(g) { throw "Syntax error, unrecognized expression: " + g; };
        var n = l.selectors = {
            order: ["ID", "NAME", "TAG"],
            match: {
                ID: /#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/ ,
            ...
            find: {
                ID: function(g, j, o) { if (typeof j.getElementById !== "undefined" && !o) return (g = j.getElementById(g[1])) && g.parentNode ? [g] : []; },
                NAME: function(g, j) {
                ...
                TAG: function(g, j) { return j.getElementsByTagName(g[1]); }
            },
            preFilter: {
            ...
            filters: {
                ...
                has: function(g, j, o) { return !!l(o[3], g).length; },
            ...
            setFilters: {
                first: function(g, j) { return j === 0; },
                last: function(g, j, o, m) { return j === m.length - 1; },
                even: function(g, j) { return j % 2 === 0; },
                odd: function(g, j) { return j % 2 === 1; },
                lt: function(g, j, o) { return j < o[3] - 0; },
                gt: function(g, j, o) { return j > o[3] - 0; },
                nth: function(g, j, o) {
                    return o[3] -
                        0 === j;
                },
            ...
            filter: {
                ...
                ID: function(g, j) { return g.nodeType === 1 && g.getAttribute("id") === j; },
                TAG: function(g, j) {
                    return j === "*" && g.nodeType === 1 || g.nodeName.toLowerCase() ===
                        j;
                },
                CLASS: function(g, j) { return (" " + (g.className || g.getAttribute("class")) + " ").indexOf(j) > -1; },
                ATTR: function(g, j) {
                    var o = j[1];
        ...
        }, s = n.match.POS, v = function(g, j) { return "\\" + (j - 0 + 1); }, B;
        for (B in n.match) {
        ...
        (function() {
            ...
            if (u.getElementById(j)) {
                n.find.ID = function(m, p, q) { if (typeof p.getElementById !== "undefined" && !q) return (p = p.getElementById(m[1])) ? p.id === m[1] || typeof p.getAttributeNode !== "undefined" && p.getAttributeNode("id").nodeValue === m[1] ? [p] : A : []; };
        ...
        (function() {
            ...
            if (g.firstChild && typeof g.firstChild.getAttribute !== "undefined" && g.firstChild.getAttribute("href") !== "#") n.attrHandle.href = function(j) { return j.getAttribute("href", 2); };
            g = null;
        })();
        u.querySelectorAll &&
            function() {
        ...
        (function() {
            ...
            if (!(!g.getElementsByClassName || g.getElementsByClassName("e").length ===
                ...
                if (g.getElementsByClassName("e").length !== 1) {
                    ...
                    n.find.CLASS = function(j, o, m) { if (typeof o.getElementsByClassName !== "undefined" && !m) return o.getElementsByClassName(j[1]); };
                    g = null;
                }
            }
        })();
        l.contains = u.documentElement.contains ? function(g, j) { return g !== j && (g.contains ? g.contains(j) : true); } : function(g, j) { return !!(g.compareDocumentPosition(j) & 16); };
        l.isXML = function(g) { return (g = (g ? g.ownerDocument || g : 0).documentElement) ? g.nodeName !== "HTML" : false; };
        var M = function(g,
            j) {
    ...
    c.fn.extend({
        ...
        not: function(a) { return this.pushStack(ka(this, a, false), "not", a); },
        filter: function(a) { return this.pushStack(ka(this, a, true), "filter", a); },
    ...
    c.fn.extend({
        ...
        domManip: function(a, b, d) {
            var e, f, h = a[0], k = [], l;
            if (!c.support.checkClone && arguments.length === 3 && typeof h === "string" && Ba.test(h)) return this.each(function() { c(this).domManip(a, b, d, true); });
            if (c.isFunction(h))
                return this.each(function(s) {
                    var v = c(this);
    ...
    var Ca = /alpha\([^)]*\)/i , db = /opacity=([^)]*)/ , eb = /-([a-z])/ig , fb = /([A-Z])/g , Da = /^-?\d+(?:px)?$/i , gb = /^-?\d/ , hb = { position: "absolute", visibility: "hidden", display: "block" }, La = ["Left", "Right"], Ma = ["Top", "Bottom"], W, ib = u.defaultView && u.defaultView.getComputedStyle, jb = function(a, b) { return b.toUpperCase(); };
        ...
        c.cssHooks[b] = {
            get: function(d, e, f) {
                ...
                if (e) {
                    ...
                    else c.swap(d, hb, function() { h = ma(d, b, f); });
                    return h + "px";
                }
            },
            set: function(d, e) {
    ...
    c.extend({
        ...
        ajax: function(a) {
            ...
            if (w) {
                ...
                b.async && b.timeout > 0 && setTimeout(function() { w && !H && M("timeout"); }, b.timeout);
                try {
            ...
            if (a || b >= this.options.duration + this.startTime) {
                ...
                if (d) {
                    if (this.options.overflow != null && !c.support.shrinkWrapBlocks) {
                        ...
                        c.each(["", "X", "Y"], function(l, n) { f.style["overflow" + n] = h.overflow[l]; });
                    }
    ...
    c.fn.offset = "getBoundingClientRect" in u.documentElement ? function(a) {
        var b = this[0], d;
        if (a) return this.each(function(k) { c.offset.setOffset(this, a, k); });
